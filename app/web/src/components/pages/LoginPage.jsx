...
const LoginPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Login - AnimeSense</title>
        <meta name="description" content="Login to AnimeSense to access your creative workspace, reference library, and connect with the art community." />
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 flex items-center justify-center px-4 py-12">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">Login to continue your creative journey</p>
          </div>
